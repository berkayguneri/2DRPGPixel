...
public class ArcherGroundedState : EnemyState
{
    ...
    public ArcherGroundedState(Enemy _enemyBase, EnemyStateMachine enemyStateMachine, string _animBoolName,EnemyArcher _enemy) : base(_enemyBase, enemyStateMachine, _animBoolName)
    {
        this.enemy = _enemy;  
    }
