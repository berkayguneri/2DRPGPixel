...
public class ArcherDeadState : EnemyState
{
    ...
    public ArcherDeadState(Enemy _enemyBase, EnemyStateMachine enemyStateMachine, string _animBoolName, EnemyArcher _enemy) : base(_enemyBase, enemyStateMachine, _animBoolName)
    {
        this.enemy = _enemy;
    }
